	...
	<head>
		...
		<script type="text/javascript">
			...
			function filter_them(selected) {
				switch (selected) {
					case '<?php echo APPLY_STATUS;?>' : location.href = '/admin/audit?orderby=' + selected + '&cur_status=' + $('#cur_status').val(); break;
					case '<?php echo APPLY_UUID;?>' : location.href = '/admin/audit?orderby=' + selected + '&apply_id=' + $('#apply_id').val(); break;
					case '<?php echo APPLY_PASSPORT;?>' : location.href = '/admin/audit?orderby=' + selected + '&passport_no=' + $('#passport_no').val(); break;
					case '<?php echo APPLY_PERIOD;?>' : location.href = '/admin/audit?orderby=' + selected + '&start_time=' + $('#start_time').val() + '&end_time=' + $('#end_time').val(); break;
					case '<?php echo APPLY_PRESENT;?>' : location.href = '/admin/audit?orderby=' + selected; break;
					default : return;
				}
			}
